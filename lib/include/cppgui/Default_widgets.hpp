...
#define CPPGUI_DEFINE_WIDGET_TYPES(Config, With_layout) \
    ...
    using Glyph_button              = cppgui::Glyph_button              <Config, With_layout, cppgui::Default_widgets<Config, With_layout>::Default_fixed_padding_box_model>; \
...
#define CPPGUI_INSTANTIATE_WIDGET_TYPES(Config, With_layout) \
    ...
    CPPGUI_INSTANTIATE_GLYPH_BUTTON             (Config, With_layout, cppgui::template Default_widgets<Config, With_layout>::Default_fixed_padding_box_model) \
