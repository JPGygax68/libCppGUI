...
namespace cppgui {
    ...
    _stringlist<Config>::Base<With_layout>::Base()
    {
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::on_item_selected(Item_selected_handler handler)
    {
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::on_item_activated(Item_activated_handler handler)
    {
    ...
    template<class Config>
    template<bool With_layout>
    void _stringlist<Config>::Base<With_layout>::set_font(const Rasterized_font * font)
    {
        _font.assign( font );
    }
    ...
    template<class Config>
    template<bool With_layout>
    void _stringlist<Config>::Base<With_layout>::init()
    {
    ...
    template<class Config>
    template<bool With_layout>
    void _stringlist<Config>::Base<With_layout>::compute_view_from_data()
    {
    ...
    template<class Config>
    template<bool With_layout>
    void _stringlist<Config>::Base<With_layout>::add_item(const std::string & text)
    {
    ...
    template<class Config>
    template<bool With_layout>
    void _stringlist<Config>::Base<With_layout>::add_item(const std::u32string & text)
    {
    ...
    template<class Config>
    template<bool With_layout>
    void _stringlist<Config>::Base<With_layout>::render(Canvas_t *canvas, const Point & offset)
    {
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::mouse_motion(const Point& pos)
    {
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::mouse_button(const Point &pos, int button, Key_state state, Count clicks)
    {
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::mouse_wheel(const Vector& delta)
    {
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::mouse_exit()
    {
        _hovered_item = -1;
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::key_down(const Keycode& key)
    {
    ...
    template<class Config>
    template<bool With_layout>
    void _stringlist<Config>::Base<With_layout>::compute_content_rectangle()
    {
    ...
    template<class Config>
    template<bool With_layout>
    auto _stringlist<Config>::Base<With_layout>::item_height() const
    {
    ...
    template <class Config>
    template <bool With_layout>
    inline auto _stringlist<Config>::Base<With_layout>::fully_visible_item_count() const -> Count
    {
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::move_by_elements(int delta)
    {
        if (delta > 0)
        {
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::move_by_pages(int delta)
    {
        if (delta > 0)
        {
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::move_by_fraction(const Fraction<int>& delta)
    {
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::update_scrollbar_position()
    {
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::select_next()
    {
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::select_previous()
    {
        if (_selected_item > 0)
        {
            select_item( _selected_item - 1 );
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::page_down()
    {
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::page_up()
    {
        if (_selected_item >= 0)
        {
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::activate_selected_item()
    {
        if (_selected_item >= 0)
        {
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::raise_item_activated(Index index, const std::u32string& item)
    {
    ...
    template <class Config>
    template <bool With_layout>
    auto _stringlist<Config>::Base<With_layout>::item_at_pos(const Point& pos) -> Index
    {
    ...
    template <class Config>
    template <bool With_layout>
    void _stringlist<Config>::Base<With_layout>::select_item(Index index)
    {
