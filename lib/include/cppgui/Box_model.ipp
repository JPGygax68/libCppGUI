...
namespace cppgui
{
    ...
    constexpr auto Box_model_base<Config, With_layout>::Aspect<Impl, Parent>::box_rectangle() const -> Rectangle
    {
        return {
            {
                p()->box_inset(3),
    ...
    template <class Config, bool With_layout>
    template <class Impl, class Parent>
    constexpr auto Box_model_base<Config, With_layout>::Aspect<Impl, Parent>::content_rectangle() const -> Rectangle
    {
        return {
            {
                p()->content_inset(3),
