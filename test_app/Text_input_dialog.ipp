...
Text_input_dialog<Config, With_layout>::Text_input_dialog()
{
    ...
    set_layout_manager<cppgui::layouting<GUI_config>::Header_content>();
    set_background_color(default_dialog_background_color());
    _border = {1, {0, 0, 0, 1}};
    //set_padding(1);

    //_header_bar.set_layout_type(cppgui::Layout_type::content_tail);
    _header_bar.set_layout_manager<cppgui::layouting<GUI_config>::Content_tail>();
    ...
    _input_row.set_layout_manager<cppgui::layouting<GUI_config>::Content_tail>();
    ...
    _main_body.set_layout_manager<cppgui::layouting<GUI_config>::Content_footer>();
