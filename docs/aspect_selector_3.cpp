...
template <bool For_real>
struct My_class : public select_aspect<For_real, My_real_layouter, My_dummy_layouter>::template aspect<Dummy_parent> {

};

int main()
{
    My_class<false> layouter1;
    My_class<true > layouter2;
